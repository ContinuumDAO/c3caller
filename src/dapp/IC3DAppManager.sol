...
interface IC3DAppManager {
    ...
    event SetDAppConfig(uint256 indexed dappID, address indexed admin, address indexed feeToken, string metadata);
    event SetDAppAddr(uint256 indexed _dappID, string[] _addresses);
    event AddMpcAddr(uint256 indexed _dappID, string _addr, string _pubkey);
    event DelMpcAddr(uint256 indexed _dappID, string _addr, string _pubkey);
    event SetFeeConfig(address indexed _token, string indexed _chain, uint256 _perByteFee, uint256 _perGasFee);
    ...
    event Charging(uint256 indexed _dappID, address indexed _token, uint256 _bill, uint256 _discount, uint256 _left);
