...
// import {MaliciousFeeToken} from "../mocks/MaliciousFeeToken.sol";
...
//
//     MaliciousFeeToken public maliciousToken;
//
...
//         maliciousToken = new MaliciousFeeToken(dappManager);
//
//         // Setup dapp config
//         vm.startPrank(gov);
//         dappManager.setFeeConfig(address(usdc), 1, 1);
//         dappManager.setFeeMinimumDeposit(address(usdc), 100);
//
//         dappManager.setFeeConfig(address(maliciousToken), 1, 1);
//         dappManager.setFeeMinimumDeposit(address(maliciousToken), 100);
//         vm.stopPrank();
//
//         vm.prank(user1);
//         dappID = dappManager.initDAppConfig(c3pingDAppKey, address(usdc), c3pingMetadata);
//
//         vm.prank(user2);
//         maliciousDAppID = dappManager.initDAppConfig(maliciousDAppKey, address(maliciousToken), maliciousMetadata);
//     }
//
//     // ============ CONSTRUCTOR TESTS ============
//
...
//         assertEq(dappManager.dappIDRegistry(), 2); // 2 DApps already registered
//     }
//
//     // ============ PAUSE/UNPAUSE TESTS ============
//
