...
contract C3GovClientTest is Helpers {
    ...
    function test_ApplyGov_NoPendingGov() public {
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(IC3GovClient.C3GovClient_IsZeroAddress.selector, C3ErrorParam.Gov));
        govClient.applyGov();
    }
    ...
    function test_AddOperator_ZeroAddress() public {
        vm.prank(gov);
        vm.expectRevert(abi.encodeWithSelector(IC3GovClient.C3GovClient_IsZeroAddress.selector, C3ErrorParam.Operator));
    ...
    function test_AddOperator_AlreadyOperator() public {
        ...
        vm.prank(gov);
        vm.expectRevert(abi.encodeWithSelector(IC3GovClient.C3GovClient_AlreadyOperator.selector, user1));
        govClient.addOperator(user1);
    }
    ...
    function test_RevokeOperator_NotOperator() public {
        vm.prank(gov);
        vm.expectRevert(abi.encodeWithSelector(IC3GovClient.C3GovClient_IsNotOperator.selector, user1));
        govClient.revokeOperator(user1);
    }
